...
Hero9.defaultProps = {
  ...
  action1: 'Learn More',
  image1Src:
    'https://images.unsplash.com/photo-1557164928-61b165508987?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxNTI3MDg3MHw&ixlib=rb-4.0.3&q=80&w=1080',
  content1:
    'Join us on a journey towards personal growth and wellness. Let FIITWELL be your guide to achieving physical, mental, and social well-being.',
  action2: 'Get Started',
}
